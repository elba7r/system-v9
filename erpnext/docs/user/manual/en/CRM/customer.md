...
Contacts and Addresses in Revalue ERP are stored separately so that you can
...
Revalue ERP allows you to group your Customers using [Customer Group]({{docs_base_url}}/user/manual/en/CRM/setup/customer-group.html) 
