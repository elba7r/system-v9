...
In some business, user collect the rates from their supplier against the customer requirement and based on the supplier rates they prepare the quotation for the customer. In Revalue ERP user get an option to make supplier quotation from the opportunity.
