...
Revalue ERP has several [types of reports](/docs/user/manual/en/customize-revalue/articles/making-custom-reports-in-revalue) which can be customize as per the companies/users requirement.
