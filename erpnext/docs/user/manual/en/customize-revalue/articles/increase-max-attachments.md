...
In Revalue ERP, you can limit how many files can be attached to specific Document. Using Custmize Form, you can set **Max(imum) Attachments** which can be added to a particular documents.
...
After update Max Attachments, Update Customization Form. Reload your Revalue ERP account and then check specific Quotation to confirm if Max Attachment limit is applied.
