...
Click [here]({{docs_base_url}}/user/manual/en/customize-revalue/articles/field-types.html) to learn more about types of field you can set for your Custom Field.

####Set Option

Based on the Field Type, value will be entered in the Options field.

If you are creating a Link field, then in the Options, enter Doctype name with which this field will be linked. Click [here]({{docs_base_url}}/user/manual/en/customize-revalue/articles/creating-custom-link-field.html) to learn more about creating custom link field.
