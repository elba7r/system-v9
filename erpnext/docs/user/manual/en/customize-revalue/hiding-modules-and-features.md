...
Click [here]({{docs_base_url}}/user/manual/en/customize-revalue/articles/module-visibility.html) to learn about other features from where icons from the desktop can be hidden.
