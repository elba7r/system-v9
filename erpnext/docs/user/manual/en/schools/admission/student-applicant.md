...
<img class="screenshot" alt="Student Applicant" src="{{url_prefix}}{{docs_base_url}}/assets/img/schools/admission/student-applicant.png">
...
<img class="screenshot" alt="Student Applicant Enrollment" src="{{url_prefix}}{{docs_base_url}}/assets/img/schools/admission/student-applicant-enroll.png">
