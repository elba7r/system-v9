...
Items for which Serial No. and Batch No. is maintained, opening stock balance entry for them is update via Stock Entry. [Click here to learn how serialized inventory is managed in Revalue ERP]({{docs_base_url}}/user/manual/en/stock/serial-no.html).
...
[Click here to learn how Batchwise inventory is managed in Revalue ERP.]({{docs_base_url}}/user/manual/en/stock/articles/managing-batch-wise-inventory.html)
