...
1. [Bulk Renaming]({{docs_base_url}}/user/manual/en/using-revalue/articles/bulk-rename.html)
2. [Document Merging]({{docs_base_url}}/user/manual/en/using-revalue/articles/merging-documents.html)
