...
If some document requires an action from User, you can Assign that document to that User. On assignment, User to whom document is assigned is intimated via email. To learn about Assign To feature, [click here.](/docs/user/manual/en/using-revalue/assignment.html)
...
[Read more about Tags](/docs/user/manual/en/using-revalue/tags.html)
