...
To Do is a simple tool where all the activities [assigned](/docs/user/manual/en/using-revalue/assignments.html) to you and assigned by you are listed. You can also add your own to-do items in the list.
